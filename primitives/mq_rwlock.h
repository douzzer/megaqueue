...
#define MQ_RWLOCK_PRIORITYORDER_SUPPORT_BIT MQ_RWLOCK_PRIORITYORDER
#else
#define MQ_RWLOCK_PRIORITYORDER_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_INHERITPRIORITY_SUPPORT
#define MQ_RWLOCK_INHERITPRIORITY_SUPPORT_BIT MQ_RWLOCK_INHERITPRIORITY
#else
#define MQ_RWLOCK_INHERITPRIORITY_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_INHERITPEAKPRIORITY_SUPPORT
#define MQ_RWLOCK_INHERITPEAKPRIORITY_SUPPORT_BIT MQ_RWLOCK_INHERITPEAKPRIORITY
#else
#define MQ_RWLOCK_INHERITPEAKPRIORITY_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_RECURSION_SUPPORT
#define MQ_RWLOCK_RECURSION_SUPPORT_BIT MQ_RWLOCK_RECURSION
#else
#define MQ_RWLOCK_RECURSION_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_ADAPTIVE_SUPPORT
#define MQ_RWLOCK_ADAPTIVE_SUPPORT_BIT MQ_RWLOCK_ADAPTIVE
#else
#define MQ_RWLOCK_ADAPTIVE_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_EXTRAERRORCHECKING_SUPPORT
#define MQ_RWLOCK_EXTRAERRORCHECKING_SUPPORT_BIT MQ_RWLOCK_EXTRAERRORCHECKING
#else
#define MQ_RWLOCK_EXTRAERRORCHECKING_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_NOCOSTLYERRORCHECKING_SUPPORT
#define MQ_RWLOCK_NOCOSTLYERRORCHECKING_SUPPORT_BIT MQ_RWLOCK_NOCOSTLYERRORCHECKING
#else
#define MQ_RWLOCK_NOCOSTLYERRORCHECKING_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_DEBUGGING_SUPPORT
#define MQ_RWLOCK_DEBUGGING_SUPPORT_BIT MQ_RWLOCK_DEBUGGING
#else
#define MQ_RWLOCK_DEBUGGING_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_ABORTWHENCORRUPTED_SUPPORT
#define MQ_RWLOCK_ABORTWHENCORRUPTED_SUPPORT_BIT MQ_RWLOCK_ABORTWHENCORRUPTED
#else
#define MQ_RWLOCK_ABORTWHENCORRUPTED_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_ABORTONMISUSE_SUPPORT
#define MQ_RWLOCK_ABORTONMISUSE_SUPPORT_BIT MQ_RWLOCK_ABORTONMISUSE
#else
#define MQ_RWLOCK_ABORTONMISUSE_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_ABORTONEDEADLK_SUPPORT
#define MQ_RWLOCK_ABORTONEDEADLK_SUPPORT_BIT MQ_RWLOCK_ABORTONEDEADLK
#else
#define MQ_RWLOCK_ABORTONEDEADLK_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_REPORTINVERSIONS_SUPPORT
#define MQ_RWLOCK_REPORTINVERSIONS_SUPPORT_BIT MQ_RWLOCK_REPORTINVERSIONS
#else
#define MQ_RWLOCK_REPORTINVERSIONS_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_AVERTINVERSIONS_SUPPORT
#define MQ_RWLOCK_AVERTINVERSIONS_SUPPORT_BIT MQ_RWLOCK_AVERTINVERSIONS
#else
#define MQ_RWLOCK_AVERTINVERSIONS_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_STATISTICS_SUPPORT
#define MQ_RWLOCK_STATISTICS_SUPPORT_BIT MQ_RWLOCK_STATISTICS
#else
#define MQ_RWLOCK_STATISTICS_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_ROBUST_SUPPORT
#define MQ_RWLOCK_ROBUST_SUPPORT_BIT MQ_RWLOCK_ROBUST
#else
#define MQ_RWLOCK_ROBUST_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_INTELRTM_SUPPORT
#define MQ_RWLOCK_INTELRTM_SUPPORT_BIT MQ_RWLOCK_INTELRTM
#else
#define MQ_RWLOCK_INTELRTM_SUPPORT_BIT 0UL
#endif

#ifdef MQ_RWLOCK_NOLOCKTRACKING_SUPPORT
#define MQ_RWLOCK_NOLOCKTRACKING_SUPPORT_BIT MQ_RWLOCK_NOLOCKTRACKING
#else
#define MQ_RWLOCK_NOLOCKTRACKING_SUPPORT_BIT 0UL
#endif

#define MQ_RWLOCK_LOCALBUILDFLAGS ( MQ_RWLOCK_PRIORITYORDER_SUPPORT_BIT \
   | MQ_RWLOCK_INHERITPRIORITY_SUPPORT_BIT \
   | MQ_RWLOCK_INHERITPEAKPRIORITY_SUPPORT_BIT \
   | MQ_RWLOCK_RECURSION_SUPPORT_BIT \
   | MQ_RWLOCK_ADAPTIVE_SUPPORT_BIT \
   | MQ_RWLOCK_EXTRAERRORCHECKING_SUPPORT_BIT \
   | MQ_RWLOCK_NOCOSTLYERRORCHECKING_SUPPORT_BIT \
   | MQ_RWLOCK_DEBUGGING_SUPPORT_BIT \
   | MQ_RWLOCK_ABORTWHENCORRUPTED_SUPPORT_BIT \
   | MQ_RWLOCK_ABORTONMISUSE_SUPPORT_BIT \
   | MQ_RWLOCK_ABORTONEDEADLK_SUPPORT_BIT \
   | MQ_RWLOCK_REPORTINVERSIONS_SUPPORT_BIT \
   | MQ_RWLOCK_AVERTINVERSIONS_SUPPORT_BIT \
   | MQ_RWLOCK_STATISTICS_SUPPORT_BIT \
   | MQ_RWLOCK_ROBUST_SUPPORT_BIT \
   | MQ_RWLOCK_INTELRTM_SUPPORT_BIT \
   | MQ_RWLOCK_NOLOCKTRACKING_SUPPORT_BIT \
  )

static const uint64_t __MQ_RWLock_LocalBuildFlags = MQ_RWLOCK_LOCALBUILDFLAGS;

#ifndef MQ_RWLOCK_LOCALDEFAULTFLAGS
//#define MQ_RWLOCK_LOCALDEFAULTFLAGS __MQ_RWLock_LocalBuildFlags
#define MQ_RWLOCK_LOCALDEFAULTFLAGS MQ_RWLOCK_LOCALBUILDFLAGS
#endif
